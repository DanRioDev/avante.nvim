...
---@return { new_content: string, enable_project_context: boolean, enable_diagnostics: boolean, enable_pullrequest_context: boolean }
function M.extract_mentions(content)
  ...
  local enable_pullrequest_context = false
  ...
  if content:match("@pr") then
    enable_pullrequest_context = true
  ...
  return {
    ...
    enable_pullrequest_context = enable_pullrequest_context,
  }
end
